...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var ans = distanceBetween * 0.00062137;
            ...
            Console.WriteLine($"{firstTB.Name} and {secondTB.Name} are the two farthest apart, with a difference in distance of {ans} miles");
